 ...
 * =====================================================================================
 *
 *       Filename:  wx_hello.cpp
 *
 *    Description:  Copied from webpage
 *
 *        Version:  1.0
 *        Created:  Thursday 21 February 2013 04:22:00  IST
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  Neil Xavier DSOUza
 *         compile with `wx-config --libs core,base,media`
 *
 * =====================================================================================
 */
...
public:
    ...
    wxPanel panel_;
    wxMediaCtrl* mediactrl_;   //Our media control
...
BEGIN_EVENT_TABLE(MyFrame, wxFrame)
    ...
    EVT_MEDIA_LOADED(wxID_MEDIACTRL, MyFrame::OnMediaLoaded)
END_EVENT_TABLE()
       ...
       : wxFrame((wxFrame *)NULL, -1, title, pos, size)
{
    ...
    bool bOK = mediactrl_->Create(this, wxID_MEDIACTRL, wxEmptyString,
                                    wxDefaultPosition, wxDefaultSize);
    mediactrl_->ShowPlayerControls(wxMEDIACTRLPLAYERCONTROLS_DEFAULT);
    using namespace std;
	//wxString hard_coded_path = wxT("./capture-28.avi");
	wxString hard_coded_path = wxT("/home/nxd/Progs/wx/wx-media-ctrl/video-2012-04-01-13-36-59.mp4");
	...
	cout << "hard_coded_path: " << hard_coded_path.mb_str() << endl;

    //if (mediactrl_->Play()) {
    //    	cout << "Able to Play" << endl;
    //} else {
    //    	cout << "UnAble to Play" << endl;
    //}
...
void MyFrame::OnMediaLoaded(wxMediaEvent& WXUNUSED(evt))
{
#if 0
