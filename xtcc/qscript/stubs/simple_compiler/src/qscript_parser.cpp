...
void print_setup_do_freq_counts(FILE *script);
...
void GenerateCode(const string & src_file_name, bool ncurses_flag)
{
	...
	print_setup_do_freq_counts(script);
...
void print_eval_questionnaire (FILE* script, ostringstream & program_code, bool ncurses_flag)
{
	...
	fprintf(script, "setup_do_freq_counts();\n");
	...
	fprintf(script, "		static int start_time_in_secs = prev_time_in_secs;\n");
	...
	fprintf(script, "				<< \"this interval speed: \" << sample_size / delta_secs << \" recs/sec\" << endl\n");
	fprintf(script, "				<< \"overall speed: \" << n_recs_written / (current_time - start_time_in_secs) << \" recs/sec\"\n");
	fprintf(script, "				<< endl;\n");
	...
	fprintf (script, "		if (rdg_counter %% sample_size == 0) {\n");
	fprintf (script, "			int current_time = time(0);\n");
	fprintf (script, "			int delta_secs = current_time - prev_time_in_secs;\n");
	fprintf (script, "			cout << \"next \" << sample_size << \" records were written in: \"\n");
	fprintf (script, "				<< delta_secs << endl\n");
	fprintf (script, "				<< \"this interval speed: \" << sample_size / delta_secs << \" recs/sec\" << endl\n");
	fprintf (script, "				<< \"overall speed: \" << rdg_counter / (current_time - start_time_in_secs) << \" recs/sec\"\n");
	fprintf (script, "				;\n");
	fprintf (script, "			prev_time_in_secs = current_time;\n");
	fprintf (script, "		}\n");
	fprintf (script, "\n");
