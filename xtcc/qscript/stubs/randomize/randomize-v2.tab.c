...
#line 91 "randomize-v2.y"
    {
		...
		//active_named_range-
		//$$ = $5;
		NamedRangeGroup * nrg = new NamedRangeGroup ((yyvsp[(2) - (6)].name), stub_number.back());
...
#line 157 "randomize-v2.y"
    {
		...
		*/
		...
		NamedRangeGroup * nrg = new NamedRangeGroup ((yyvsp[(2) - (6)].name), stub_number[stub_number.size()-2]);
		nrg->groupPtr_ = nr_ptr;
		(yyval.nr_ptr) = nrg;
		int highest_stub_number_in_group = stub_number.back() ;
